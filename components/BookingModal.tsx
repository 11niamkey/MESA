            ...
            <div className="mb-8 bg-white rounded-xl">
              <div className="flex flex-col md:flex-row md:items-start gap-5">
                <img 
                  ...
                  className="w-full md:w-32 md:h-32 rounded-xl object-cover shadow-md" 
                />
                <div className="flex-1">
                  ...
                  {/* Badges: Prep time, Portion, Tags */}
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    <span className="px-2.5 py-1 bg-orange-50 text-orange-800 rounded-lg text-[10px] font-bold flex items-center gap-1">
                      <Clock className="w-3 h-3 text-orange-600" /> Preavviso: 25-35 min
                    </span>
                    <span className="px-2.5 py-1 bg-gray-100 text-gray-700 rounded-lg text-[10px] font-bold flex items-center gap-1">
                      <Utensils className="w-3 h-3 text-gray-600" /> Porzione: ~350g
                    </span>
                    {dish.tags.map(tag => (
                      <span key={tag} className="px-2 py-1 bg-gray-50 border border-gray-200 rounded-lg text-[10px] font-semibold text-gray-500">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        type="button"
                        className="p-1.5 rounded-lg bg-white shadow-sm border border-gray-100 text-gray-600 hover:bg-gray-50 transition-colors disabled:opacity-45 disabled:cursor-not-allowed"
                        disabled={
                      ...
                      <button
                        ...
                        type="button"
                        className="p-1.5 rounded-lg bg-white shadow-sm border border-gray-100 text-gray-600 hover:bg-gray-50 transition-colors"
                      >
          ...
          <div className="bg-gray-50 px-6 py-4 flex justify-between items-center border-t border-gray-200">
            ...
            <div className="flex space-x-3 w-full sm:w-auto">
              ...
              <button
                ...
                disabled={!date || !time}
                className="flex-1 sm:flex-none px-6 py-2.5 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 flex items-center justify-center"
              >
                Conferma
              </button>
            </div>
