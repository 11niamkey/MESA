      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            >
              <div className="w-11 h-11 md:w-16 md:h-16 rounded-xl overflow-hidden bg-black shadow-lg shadow-orange-900/20 group-hover:scale-105 transition-all outline outline-1 outline-white/10 ml-[-4px] my-1">
