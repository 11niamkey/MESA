        ...
        {specials.map((dish) => (
          ...
          >
            ...
            <div className="p-6 sm:p-8">
              ...
              <button className="w-full py-4 sm:py-5 rounded-[1.5rem] sm:rounded-[2rem] bg-black text-white font-black uppercase tracking-widest text-[11px] sm:text-sm flex items-center justify-center space-x-2 sm:space-x-3 group-hover:bg-orange-600 transition-all shadow-xl active:scale-95">
