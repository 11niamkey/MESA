      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            >
              {/* Logo Icon Badge with Glowing Ambient Ring */}
              <div className="relative shrink-0">
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 via-amber-500 to-orange-500 rounded-2xl blur-sm opacity-70 group-hover:opacity-100 group-hover:blur-md transition-all duration-300"></div>
                <div className="relative w-11 h-11 md:w-14 md:h-14 rounded-2xl bg-black border border-orange-500/50 p-1 flex items-center justify-center overflow-hidden shadow-2xl group-hover:border-orange-400 transition-colors">
                  <img 
                    src="/images/mesa_logo_type.png" 
                    alt="MESA" 
                    className="w-full h-full object-contain filter drop-shadow-[0_2px_8px_rgba(249,115,22,0.5)]" 
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col min-w-0">
                <div className="flex items-center gap-1.5">
                  <span className="text-lg md:text-2xl font-black tracking-tight text-white group-hover:text-orange-400 transition-colors font-sans leading-none">
