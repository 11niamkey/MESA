                  ...
                  <div className="space-y-4">
                    {associatedChef && (
                      <div 
                        ...
                        className="flex items-center justify-between p-3.5 bg-gray-50/50 hover:bg-orange-50/50 rounded-2xl border border-gray-150 transition-colors group/chef cursor-pointer"
                      >
                    ...
                    {/* Book Now Button */}
                    <button className="w-full py-4 rounded-2xl bg-black text-white font-black uppercase tracking-widest text-[10px] sm:text-xs flex items-center justify-center gap-2 group-hover:bg-orange-600 transition-all shadow-xl active:scale-95 border-b-4 border-b-black group-hover:border-b-orange-700">
